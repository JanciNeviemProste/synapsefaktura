...
editoriálny štýl landingu by v dátovej appke škodil použiteľnosti.
...
- **Fonty.** `db.onlinewebfonts.com` servíruje *Helvetica Now Display*
...
a vnútro pri sebe. ⚠️ `.landing-light` z tohto kola sa v ďalšom **ukázal ako
nesprávny nástroj** a je zrušený — viď záznam o teplej šedej vyššie.
