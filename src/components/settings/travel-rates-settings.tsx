...
export function TravelRatesSettings({
    ...
    <Card>
      <CardHeader className="flex flex-row items-start justify-between">
        <div className="grid gap-1">
          ...
          <CardDescription>
            Sadzba za služobný kilometer. Jazda sa počíta sadzbou platnou v čase
            jazdy, preto má každá platnosť od-do. Vlastná sadzba firmy má
            prednosť pred zákonnou.
          </CardDescription>
        </div>
 ...
 potvrdenia sa NEPOUZIVA — dañove cislo sa nema zmenit samo. */}
        {pending ? (
          <div className="bg-muted/30 grid gap-2 rounded-md border-l-2 border-l-amber-500 p-3">
